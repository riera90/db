...
% Debido a que un paciente podrá efectuar múltiples análisis, la relación será de 1:N, ya que un análisis será solo de un cliente.
...
\scalebox{.74}{
\hspace{-2.0cm}
\includegraphics{diagrams/er.png}\\
}
\end{center}
...
% \pagebreak
%
% \section{Especificación de atributos.}
